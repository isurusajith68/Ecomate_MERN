  ...
  return (
    <div>
      ...
      <aside className="text-black p-6 pr-0">
        ...
        <Link to={"/dashboard"} className="flex gap-3 mb-8 mr-3">
          <svg
          ...
          <span className="text-white">ECOMAT Admin</span>
        </Link>
        ...
        <nav className="flex flex-col gap-2">
          ...
          <Link
            to={"/resource"}
            className={
              pathname.includes("/resource") ? activelink : inactivelink
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <Link className="flex gap-7" onClick={handleSignOut} to={'/login'}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
